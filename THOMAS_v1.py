...
from libraries.ants_nonlinear1 import ants_nonlinear_registration, bias_correct
...
parser.add_argument('mask_image', help='input mask_NiFTI image')
...
def main(args, temp_path, pool):
    ...
    if args.forcereg or not check_warps(warp_path):
        ...
        ants_nonlinear_registration(template, input_image, warp_path, mask_image, **exec_options)
    else:
    ...
    # cmd = 'gunzip image.nii.gz | cp temp/image.nii.gz ./ ' % ()
